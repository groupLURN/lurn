...
/**
 * ManpowerTypesTasksFixture
 *
 */
class ManpowerTypesTasksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'manpower_types_tasks_ibfk_1' => ['type' => 'foreign', 'columns' => ['manpower_type_id'], 'references' => ['manpower_types', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'manpower_types_tasks_ibfk_2' => ['type' => 'foreign', 'columns' => ['task_id'], 'references' => ['tasks', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'quantity' => 1,
            'created' => '2016-03-08 23:41:41',
            'modified' => '2016-03-08 23:41:41'
        ],
    ];
}
