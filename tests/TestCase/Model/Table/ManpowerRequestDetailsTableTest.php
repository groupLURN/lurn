...
use App\Model\Table\ManpowerRequestDetailsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ManpowerRequestDetailsTable Test Case
 */
class ManpowerRequestDetailsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ManpowerRequestDetailsTable
     */
    public $ManpowerRequestDetails;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ManpowerRequestDetails') ? [] : ['className' => 'App\Model\Table\ManpowerRequestDetailsTable'];
        $this->ManpowerRequestDetails = TableRegistry::get('ManpowerRequestDetails', $config);
    }
    ...
    {
        unset($this->ManpowerRequestDetails);
