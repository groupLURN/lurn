...
use App\Model\Table\IncidentReportHeadersTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\IncidentReportHeadersTable Test Case
 */
class IncidentReportHeadersTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\IncidentReportHeadersTable
     */
    public $IncidentReportHeaders;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('IncidentReportHeaders') ? [] : ['className' => 'App\Model\Table\IncidentReportHeadersTable'];
        $this->IncidentReportHeaders = TableRegistry::get('IncidentReportHeaders', $config);
    }
    ...
    {
        unset($this->IncidentReportHeaders);
