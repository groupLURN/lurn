...
/**
 * EquipmentGeneralInventoriesFixture
 *
 */
class EquipmentGeneralInventoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['equipment_id'], 'length' => []],
            'equipment_general_inventories_ibfk_1' => ['type' => 'foreign', 'columns' => ['equipment_id'], 'references' => ['equipment', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
