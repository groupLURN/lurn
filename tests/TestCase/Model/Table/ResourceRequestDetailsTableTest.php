...
use App\Model\Table\ResourceRequestDetailsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ResourceRequestDetailsTable Test Case
 */
class ResourceRequestDetailsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ResourceRequestDetailsTable
     */
    public $ResourceRequestDetails;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ResourceRequestDetails') ? [] : ['className' => 'App\Model\Table\ResourceRequestDetailsTable'];
        $this->ResourceRequestDetails = TableRegistry::get('ResourceRequestDetails', $config);
    }
    ...
    {
        unset($this->ResourceRequestDetails);
