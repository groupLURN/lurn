...
/**
 * EquipmentReplenishmentDetailsFixture
 *
 */
class EquipmentReplenishmentDetailsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'equipment_replenishment_details_ibfk_1' => ['type' => 'foreign', 'columns' => ['task_id'], 'references' => ['tasks', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'equipment_replenishment_details_ibfk_2' => ['type' => 'foreign', 'columns' => ['equipment_id'], 'references' => ['equipment', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'equipment_id' => 1,
            'quantity' => 1,
            'created' => '2016-03-24 15:42:04',
            'modified' => '2016-03-24 15:42:04'
        ],
    ];
}
