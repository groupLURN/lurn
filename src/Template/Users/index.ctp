    ...
    <div class="col-xs-12">
        <div class="content-panel">
            <table class="table table-striped table-advance table-hover">
                <h4><i class="fa fa-angle-right"></i> <?= __('Users') ?> </h4>
                <hr>
                <thead>
                <tr>
                ...
                <?php foreach ($users as $user): ?>
                    <tr>
                        <td><?= $user->has('user_type') ? $this->Html->link($user->user_type->title, ['controller' => 'UserTypes', 'action' => 'view', $user->user_type->id]) : '' ?></td>
                        <td><?= h($user->username) ?></td>
                        <td class="actions">
                            <?= $this->dataTableViewButton(__('View'), ['action' => 'view', $user->id]); ?>
                            <?= $this->dataTableEditButton(__('Edit'), ['action' => 'edit', $user->id]); ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
