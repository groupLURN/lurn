...
/**
 * MaterialsProjectInventoriesFixture
 *
 */
class MaterialsProjectInventoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['material_id', 'project_id'], 'length' => []],
            'materials_project_inventories_ibfk_1' => ['type' => 'foreign', 'columns' => ['material_id'], 'references' => ['materials', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'materials_project_inventories_ibfk_2' => ['type' => 'foreign', 'columns' => ['project_id'], 'references' => ['projects', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
